...
\begin{longtable}{p{0.97in}|p{4.95in}}
	2018$-$Presente & Profesor agregado interino, Dpto. Psicología Social y Psicología Cuantitativa \\
...
2023$-$Presente & \textbf{Asignatura:} Fundamentos de modelos estadísticos. \textbf{Titulación:} Máster en Behavioural Data Sciences.\\
