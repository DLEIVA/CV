...
\begin{longtable}{p{0.5in}|p{5.5in}}
  2024 & \bibentry{czakert2024}\textbf{Impact Factor}: $2.9$.\\
       & \bibentry{galant2024}\textbf{Impact Factor}: $3.0$.\\
       & \bibentry{caldu2024}\textbf{Impact Factor}: $4.4$.\\
       & \bibentry{blasco2024}\textbf{Impact Factor}: $3.8$.\\       
  2023 & \bibentry{castellvi2023}\textbf{Impact Factor}: $4.997$.\\
       & \bibentry{berger2023}\textbf{Impact Factor}: $4.68$.\\
       & \bibentry{rivero2023}\textbf{Impact Factor}: $2.0$.\\
       & \bibentry{leniz2023}\textbf{Impact Factor}: $2.0$.\\
       & \bibentry{leniz2023b}\textbf{Impact Factor}: $2.0$.\\       
       & \bibentry{galant2023}\textbf{Impact Factor}: $3.0$.\\
...
\textbf{Motivació, absentisme i rendiment acadèmic en Educació Superior: Estudi longitudinal intensiu} Project granted by the \emph{Institut de Ciències de l'Educació - Universitat de Barcelona} (2024-2025). Lead Researcher: David Leiva Ure\~{n}a. \\
...
2023$-$Present & \textbf{Course:} Visualización de datos y reproducibilidad. \textbf{Program:} Master Program in Behavioral Data Sciences.\\

2023$-$Present & \textbf{Course:} Fundamentos de modelos estadísticos. \textbf{Program:} Master Program in Behavioural Data Sciences.\\

2022$-$Present & \textbf{Course:} Gestión y organización de datos. \textbf{Program:} Master Program in Behavioural Data Sciences.\\

2022$-$2024 & \textbf{Course:} Bioestadística i Matemàtica Aplicada. \textbf{Program:} Degree in Foods Sciences.\\
...
2016$-$2020 & \textbf{Course:} Aplicacions de la Bioestadística a la salut. \textbf{Program:} Master \emph{Lideratge i Gestió dels Serveis d'Infermeria}.\\
...
\begin{longtable}{p{6in}}
  ...
  \textbf{Modelos lineales (generalizos) mixtos}. Course organized by the \emph{Research Group ContexED}. 6 hours taught in July 2024 jointly with Dr. Rumen Manolov. \\

  \textbf{Research Methods in Cyberspace, Behavior and e-Therapy}. Course organized by the \emph{School of Psychology and Life Sciences} of the University Lusófona of Lisbon. 12 hours, taught in October 2023. \\

  \textbf{Research Methods in Cyberspace, Behavior and e-Therapy}. Course organized by the \emph{School of Psychology and Life Sciences} of the University Lusófona of Lisbon. 12 hours, taught in November 2022. \\
