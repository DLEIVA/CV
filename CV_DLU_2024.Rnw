...
\begin{longtable}{p{0.5in}|p{5.5in}}
  2024 & \bibentry{czakert2024}\textbf{Factor de Impacto}: $2.9$.\\
       & \bibentry{galant2024}\textbf{Factor de Impacto}: $3.0$.\\
       & \bibentry{caldu2024}\textbf{Factor de Impacto}: $4.4$.\\
       & \bibentry{blasco2024}\textbf{Factor de Impacto}: $3.8$.\\
  2023 & \bibentry{castellvi2023}\textbf{Factor de Impacto}: $4.997$.\\
       & \bibentry{berger2023}\textbf{Factor de Impacto}: $4.68$.\\
       & \bibentry{rivero2023}\textbf{Factor de Impacto}: $2.0$.\\
       & \bibentry{leniz2023}\textbf{Factor de Impacto}: $2.0$.\\
       & \bibentry{leniz2023b}\textbf{Factor de Impacto}: $2.0$.\\    
       & \bibentry{galant2023}\textbf{Factor de Impacto}: $3.0$.\\
...
\begin{longtable}{p{0.5in}|p{5.5in}}
  2024 & \bibentry{pnavarro2024} \\
       & \bibentry{privero2024} \\
  2023 & \bibentry{pnavarro2023} \\
       & \bibentry{privero2023} \\
       & \bibentry{pezzeddine2023} \\
       & \bibentry{pescorcia2023} \\       
...
\setlength{\extrarowheight}{10pt}
\begin{longtable}{p{6in}}
  \textbf{3 sexenios de Investigación}. Concedidos por la Agència de Qualitat Universitària de la Generalitat de Catalunya. Periodos: 2005 $-$ 2010; 2011 $-$ 2016 y 2017 $-$ 2022.\\
...
2023$-$Presente & \textbf{Asignatura:} Visualización de datos y reproducibilidad. \textbf{Titulación:} Máster en Behavioral Data Sciences.\\

2023$-$2024 & \textbf{Asignatura:} Fundamentos de modelos estadísticos. \textbf{Titulación:} Máster en Behavioural Data Sciences.\\

2022$-$Presente & \textbf{Asignatura:} Gestión y organización de datos. \textbf{Titulación:} Máster en Behavioural Data Sciences.\\

2022$-$2024 & \textbf{Asignatura:} Bioestadística i Matemàtica Aplicada. \textbf{Titulación:} Grado en Ciencias de la Alimentación.\\
...
2016$-$ 2020 & \textbf{Asignatura:} Aplicacions de la Bioestadística a la salut. \textbf{Titulación:} Máster Lideratge i Gestió dels Serveis d'Infermeria.\\
...
\begin{longtable}{p{6in}}
  ...
  \textbf{Modelos lineales (generalizos) mixtos}. Curso organizado el grupo de investigación \emph{ContexED}. 6 hours impartidas en Julio de 2024 conjuntamente con el Dr. Rumen Manolov. \\

  \textbf{Research Methods in Cyberspace, Behavior and e-Therapy}. Curso organizado por la \emph{School of Psychology and Life Sciences} de la Universidad Lusófona de Lisboa. 12 horas, impartido en Octubre de 2023. \\
...
\textbf{Motivació, absentisme i rendiment acadèmic en Educació Superior: Estudi longitudinal intensiu} Proyecto concedido por el \emph{Institut de Ciències de l'Educació - Universitat de Barcelona} (2024-2025). Lead Researcher: David Leiva Ure\~{n}a. \\
...
\textbf{Coordinación de asignaturas:} Asignatura obligatoria \emph{Estadística} del grado de Psicología. Periodo: 2023$-$ Actualidad. \\
